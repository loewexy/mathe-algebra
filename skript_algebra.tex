...
\begin{document}
	...
	\begin{remark}
		Wenn $K \subset L \subset M$ Körpererweiterungen sind und $K/M$ Galois ist, dann ist $L/M$ Galois, aber $K/L$ muss nicht Galois sein.
	\end{remark}
	...
	\begin{remark}
		...
		\begin{enumerate}
			...
			\item Wenn $f$ irreduzibel ist, dann operiert $\Gal(f)$ transitiv auf der Menge der Nullstellen.
	...
	\begin{proof}
		Sei $\mathbb{F}_p \subset M$ mit $m = [K: \mathbb{F}_p]$ und damit $q = p^m$.
