...
\setcounter{page}{1}
	...
	\begin{proof}
		...
		\heading{Klar ist:} Die Elemente $1,a,a^2, \dots, a^{n-1} \in k(a)$ %TODO müssen hier nicht bs stehen?
		sind linear unabhängig, denn jede lineare Relation gäbe ein Polynom $g(x)$ vom Grad $< n$ mit $g(a) = 0$ $\lightning$.
		...
		\begin{align*}
			...
			\Leftrightarrow& \frac{1}{s} = \underbrace{\frac{1}{-p_0}}_{\in k} \underbrace{(s^{m-1 + p_{m-1} s^{m-2} + \dots + p_1})}_{\substack{\text {$\in \tilde{k}$} \\ \text{ wegen Abgeschlossenheit} \\ \text{unter Multiplikation}}} \in \tilde{k}
		\end{align*}
	\end{proof}
