...
\begin{document}
	...
	\begin{theorem}[Universelle Eigenschaft]
		...
		\begin{center}
			\begin{tikzpicture}
			\node(R1) at (0,0){$R$};
			\node[right = 2 of R1](ri){$R/I$};
			\node[below = 1 of R1](R2){$R$};
			\node[below = 1 of ri](s){$S$};
	...
	\begin{proof}
		...
		\begin{center}
			\begin{tikzpicture}
			\node(R1) at (0,0){$R$};
			\node[right = 2 of R1](ri){$R/\ker(\varphi)$};
			\node[below = 1 of R1](R2){$R$};
			\node[below = 1 of ri](s){$S$};
	...
	\begin{theorem}
		...
		\begin{enumerate}
			...
			\begin{align*}
				\{ \text{Ideale in $S$} \} &\overset{\alpha}{\to} \{ \text{Idealen in $R$, die $\ker(\varphi)$ enthalten} \} \\
				I &\mapsto \varphi^{-1}(I)
			\end{align*}
			bijektiv.
	...
	\begin{proof}
		\begin{enumerate}
			...
			\begin{center}
				...
				\end{tikzpicture}
			\end{center}
			und $J = q^{-1}((0)) = q^{-1}(\eta^{-1}(0))$, setze $I = \eta^{-1}(0)$, fertig.
