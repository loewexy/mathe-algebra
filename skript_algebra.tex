...
\setcounter{page}{1}
	...
	\begin{proof}
		...
		\begin{itemize}
			...
			\item Angenommen es gäbe $j$: $p_1 \sim q_j$. Dann könnte ich in $(*)$ auf beiden Seiten $p_1$ kürzen und erhielte Polynom vom Grad $(\deg r(x)) - n < \deg r(x)$, das zwei nicht äquivalente Darstellungen hat $\lightning$ zur Minimalität von $\deg r(x)$.
		\end{itemize}
